...
<div class="ls-login-parent">
  ...
  <h1 class="ls-login-logo"><img title="Logo login" src="images/locastyle/logo-locaweb.png" /></h1>
...
<div class="ls-login-adv"><img title="Exemplo banner" src="images/banner-example.png" /></div>

    </div>
  </div>
</div>

<script src="javascripts/jquery-2.1.0.min.js" type="text/javascript"></script><script src="javascripts/locastyle.js" type="text/javascript"></script>
